...
public abstract class ParamFactory {
    ...
    public static final int[] VISIT_ATTRS = {
        Tag.SpecificCharacterSet,
        Tag.InstitutionName,
    ...
    public static final int[] SERVICE_REQUEST_ATTRS = {
        Tag.SpecificCharacterSet,
        Tag.AccessionNumber,
        Tag.IssuerOfAccessionNumberSequence,
    ...
    public static final int[] REQUESTED_PROCEDURE_ATTRS = {
        Tag.SpecificCharacterSet,
        Tag.StudyDate,
        Tag.StudyTime,
        Tag.StudyInstanceUID,
    ...
    public static final int[] SPS_ATTRS = {
        Tag.SpecificCharacterSet,
        Tag.Modality,
    ...
    public static final int[] PPS_ATTRS = {
        Tag.SpecificCharacterSet,
        Tag.Modality,
        Tag.ProcedureCodeSequence,
    ...
    public static final AttributeFilter[] ATTR_FILTERS = {
